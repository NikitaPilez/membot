...
ssh user@142.93.102.201 "cd membot && php artisan migrate && php artisan optimize && php artisan route:cache && php artisan cache:clear && php artisan config:clear && pm2 restart all" && \
